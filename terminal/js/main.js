...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        general_help: "below there's a list of commands that you can use. you can use autofill by pressing the TAB key,\nautocompleting if there's only 1 possibility, or showing you a list of possibilities.",
        ...
        welcome: "root@linux:~$ ssh guest@subho57\nLinux 5.3.0-amd64 #1 SMP Debian 5.3.15-1linux1 x86_64\n\nuse 'help' command for more information.\nin order to skip text rolling, double click/touch anywhere.\n",
        ...
        username: "Username",/* Subhankar Pal | @subho57 */
        hostname: "Host",
        platform: "Platform",
